...
{%- block extrahead %}
  ...
  <meta property="og:description" content="M2TW Engine Overhaul Project is designed to expand the capabilities of the game Medieval 2: Total War. It uses C++ and Assembly to modify the game's code in-memory and exposes this to the end user via Lua scripts and the EOP Lua Plugin.">
