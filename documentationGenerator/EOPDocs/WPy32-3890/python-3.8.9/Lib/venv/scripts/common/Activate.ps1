...
if (-not $Env:VIRTUAL_ENV_DISABLE_PROMPT) {
    ...
    function global:prompt {
        Write-Output -NoNewline -ForegroundColor Green "($_PYTHON_VENV_PROMPT_PREFIX) "
        _OLD_VIRTUAL_PROMPT
    }
}
...
# AHkAdABoAG8AbgAgADMALgA4AC4AOTAvBgkqhkiG9w0BCQQxIgQgBrni4mcRv7sM
# JHsxpROjRopOz2wuQVrJnn+lD7X7y+gwDQYJKoZIhvcNAQEBBQAEggIAhMrhAwsP
# fV3LHXj66ZcFbU/LdWRuP/zVsDWskKE2TpJleVXoLT0cX1S7cJp4NVaA/80jyu1f
# EHeZWbbfE3I8urDk3EcMDhgZier8c2UuMdkTpT6NE/ydwVFd4WTM5TRkcjxVmEfy
# BlamEVRJig9OLYY9fGowJAQe9hEzQFMISikum9z/x6L0MrfAQs6xQpMCqQkAP4D5
# Lz+E7DK1NJzcQnlH0kTMxOMmVC3YHtg9JCSu4/2cohvRlGy9DdbjJeBnapn1FjjB
# aXaX1WstbesoPJueMtHzep59RCi61vpFtkBu4u4/hWzDSlV86u8Wdo8vFUynmKQb
# LM4SrOiEUyXRPq2KBpwLRTIYD0sItZ0VNp4iqvuZDGXSIPicFef04BIVC9lVr0RA
# i4AwFbgnu2aZ/eVhb6n/6ilMnMF6w/zKV8bRsoLKuiSj4fgUYIHEEiECMyOP5eFw
# N5Vdr8R9anR7FDdN3wmVF0W5WbyctkSrFPllkm/XkdGGdtAyi3mkkYVXU74dXVGt
# QjpfN3RVsie6TK8iw8cj6DwcZKJf+8iI11go13lk3NhGr6LP32+g5J4PnRerwujX
# +OEzP6y9MSrjAi28lMqa7aCq1RIy37K0kVmSpTuHhkYuAfvLkTd7q2VY90nWf5bN
# pHA1jPqwDg9T8ZNNgyodwIojOESmV1N6y8Ohgg1EMIINQAYKKwYBBAGCNwMDATGC
...
# AAQg1s0HatuGVyreB4UHspODRYOS6UiasjoAe9MhX6FeAYQCEDeISLyFqrztrPiM
# Tyer04kYDzIwMjEwNDAyMTE0NzI5WqCCCjcwggT+MIID5qADAgECAhANQkrgvjqI
...
# EAEEMBwGCSqGSIb3DQEJBTEPFw0yMTA0MDIxMTQ3MjlaMCsGCyqGSIb3DQEJEAIM
# MRwwGjAYMBYEFOHXgqjhkb7va8oWkbWqtJSmJJvzMC8GCSqGSIb3DQEJBDEiBCB7
# 34JYeFqkKbR/DpjEQtpegefCgMNjGHHEM/eExOZWgjANBgkqhkiG9w0BAQEFAASC
# AQC8DJquEtUZoB4+FjZRD8clk26/cDtYrMTG7dlwTIJu+8oxfX+JgL5cgQKXwSpG
# UlqjbNcOyVisyq4QKGv20LTFi4UULYh2Y2fvd7WrwUbHoLIc1t0YZkY+VT2M4FRv
# Euw8SoLm9Gk7qXJHVWkLMk9nzrSAKed28lxRVjwOmpp2x2sqgo9FWoKLD5lo2K9h
# 0Nwu4/qPFBmLFfOg9WqRXyeVxsZb6NW7dyKPnHc9Hs98mILN32DeOkU0eL01E/M8
# LHU7QzMhCYpGwP00JzZkAikWbDdoe5dFLm5TB7B7WDiCaRrg1sOXVP2Y+yDv6vab
# +iL4UN2VzD0AcugXAI8dFyKQ
