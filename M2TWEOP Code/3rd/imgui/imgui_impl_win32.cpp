...
bool    ImGui_ImplWin32_Init(void* hwnd)
{
    ...
    io.KeyMap[ImGuiKey_One] = '1';
    io.KeyMap[ImGuiKey_Two] = '2';
    io.KeyMap[ImGuiKey_Three] = '3';
    io.KeyMap[ImGuiKey_Four] = '4';
    io.KeyMap[ImGuiKey_Five] = '5';
    io.KeyMap[ImGuiKey_Six] = '6';
    io.KeyMap[ImGuiKey_Seven] = '7';
    io.KeyMap[ImGuiKey_Eight] = '8';
    io.KeyMap[ImGuiKey_Nine] = '9';
    io.KeyMap[ImGuiKey_Zero] = '0';
    io.KeyMap[ImGuiKey_Tilde] = VK_OEM_3;
    ...
    io.KeyMap[ImGuiKey_LeftAlt] = VK_MENU;
